# ClassicalTestTheory.jl Documentation

Welcome to the documentation for **ClassicalTestTheory.jl**, a modern and high-performance Julia package for Classical Test Theory and Psychometrics.

## Overview

`ClassicalTestTheory.jl` provides an extensive suite of tools for:
